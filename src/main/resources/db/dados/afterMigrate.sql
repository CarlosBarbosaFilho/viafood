...
INSERT INTO viafood.tb_formas_pagamentos (id,descricao) values (1,'À vista');
INSERT INTO viafood.tb_formas_pagamentos (id,descricao) values (2,'Débito');
INSERT INTO viafood.tb_formas_pagamentos (id,descricao) values (3,'Crétido');
INSERT INTO viafood.tb_formas_pagamentos (id,descricao) values (4,'Boleto');
INSERT INTO viafood.tb_formas_pagamentos (id,descricao) values (5,'Transferência Bancária');
...
######################################################### PRODUTOS #######################################################
INSERT INTO viafood.tb_produtos (id,nome,descricao, preco, ativo, restaurante_id) values (1,'Filé Parmegiana', 'Filé mingnhon com queijo', 130, true, 1);
INSERT INTO viafood.tb_produtos (id,nome,descricao, preco, ativo, restaurante_id) values (2,'Bife à Cavala', 'Bife de maminha com ovos grelhados', 120, true, 1);
INSERT INTO viafood.tb_produtos (id,nome,descricao, preco, ativo, restaurante_id) values (3,'Filé com frita', 'Filé com batas fritas', 70, true, 2);
INSERT INTO viafood.tb_produtos (id,nome,descricao, preco, ativo, restaurante_id) values (4,'Macarronada do chef', 'Macarrão com molho de tomates especial', 80, true, 3);
INSERT INTO viafood.tb_produtos (id,nome,descricao, preco, ativo, restaurante_id) values (5,'Cordeiro Paraíba', 'Filé de cordeiro marinado no azeite e vinho do porto', 230, true, 4);
INSERT INTO viafood.tb_produtos (id,nome,descricao, preco, ativo, restaurante_id) values (6,'Carne de sol na nata', 'Carne de sol desfiada na nata e cebolas brancas', 90, true, 4);

################################  CADASTRO DAS PERMISSÕES #############################################################
INSERT INTO viafood.tb_permissoes (id,nome,descricao) values (1,'Usuário','Permite apenas o acesso de usuários comuns.');
INSERT INTO viafood.tb_permissoes (id,nome,descricao) values (2,'Visitante','Permite apenas o acesso de visitantes.');
INSERT INTO viafood.tb_permissoes (id,nome,descricao) values (3,'Administrador','Permite o acesso ao administrador do sistema.');
INSERT INTO viafood.tb_permissoes (id,nome,descricao) values (4,'Master', 'Permite acesso total a todo o sistema.');

################################  CADASTRO DAS GRUPOS ###################################################################
INSERT INTO viafood.tb_grupos (id, nome) values (1, 'Administradores');
INSERT INTO viafood.tb_grupos (id, nome) values (2, 'Gerentes ');
INSERT INTO viafood.tb_grupos (id, nome) values (3, 'Comercial');
INSERT INTO viafood.tb_grupos (id, nome) values (4, 'Suporte Técnico');

######################################################### USUARIOS #######################################################
INSERT INTO viafood.tb_usuarios (id, nome, email, senha, data_cadastro) values (1, 'Carlos Barbosa G. Filho', 'cbarbosagomesfilho@gmail.com', '123mudar', utc_timestamp);
INSERT INTO viafood.tb_usuarios (id, nome, email, senha, data_cadastro) values (2, 'Barbara de Assis Xavier', 'barbara.a.xavier@gmail.com', '123mudar', utc_timestamp);
INSERT INTO viafood.tb_usuarios (id, nome, email, senha, data_cadastro) values (3, 'Maria Alice Barbosa Xavier', 'maria.a.xavier@gmail.com', '123mudar', utc_timestamp);
